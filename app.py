...
DEFAULT_STOCKS = [
    ...
    "2308.TW", "2303.TW", "2881.TW", "2882.TW", "2603.TW"
]
...
with st.spinner("資料載入中，請稍候..."):
    df_res = fetch_data_safe(DEFAULT_STOCKS)
...
if df_res.empty:
    ...
    selected_code = st.selectbox("選擇股票代號：", options=df_sorted["代號"])
